...
def mock_adapter(mocker):
    mock_adapter = mocker.patch("src.repositories.document_db.user_repository.UserDocumentDBAdapter")
    return mock_adapter
...
def test_get_by_id(mock_adapter):
    ...
    mock_adapter.return_value.getById.return_value = {"_id": "1", "full_name": "John Doe", "email": "john.doe@example.com"}
