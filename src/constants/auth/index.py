...
EMAIL_OTP_TEMPLATE_PRINCIPAL_BUSINESS = """
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="greeting">¡Hola, <span class="bold">{{name}}</span>! Bienvenido a Talent Connect 🙌</div>
            <p>Estás a punto de unirte a la revolución en la forma de contratar: más objetiva, sin sesgos y con tecnología que sí hace la diferencia.</p>
            ...
            <div class="message">
            <p>Escríbelo para confirmar tu correo y empezar a disfrutar de todo lo que Talent Connect tiene para ofrecerte.</p>
            
            <p>¿No fuiste tú quien solicitó el código? Ignora este mensaje 😉</p>
            
            <p>¡Nos emociona que seas parte de esta nueva forma de conectar talento con oportunidades!</p>
