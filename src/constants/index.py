...
TECHCO_DOMAIN = environ.get("TECHCO_DOMAIN", "https://develop.dzkuw34ypddf5.amplifyapp.com")
...
S3_PROFILE_FILTER_CV_FILES_BUCKET_NAME = environ.get("S3_PROFILE_FILTER_CV_FILES_BUCKET_NAME", "")
